...
8. ⚡ OUTPUT BUDGET: Build a complete but concise single-page app. Prioritize the user-requested flows and working interactions; avoid repetitive markup, duplicated styles, and explanatory text in the output.`;
